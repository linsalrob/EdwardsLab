...
This is a snakefile for the processes that are done for the 2021 SAGC
metagenome workshop. 

As an alternative to running the commands in the tutorial, you can just
