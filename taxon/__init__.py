...
from .load_from_database import all_ids, taxonomy_hierarchy, all_species_ids, taxonomy_ids_as_list, acc_to_taxonomy
...
__all__ = [
    ...
    'taxonomy_hierarchy', 'taxonomy_hierarchy_as_list', 'taxonomy_ids_as_list', 'read_acc_tax_id', 'acc_to_taxonomy'
    ]
