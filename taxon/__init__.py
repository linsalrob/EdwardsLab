...
from .load_from_database import get_taxonomy_db, get_taxonomy, connect_to_db, get_taxid_for_name
...
__all__ = [
    ...
    'get_taxonomy_db', 'get_taxonomy', 'connect_to_db', 'get_db_dir', 'get_taxid_for_name'
    ]
