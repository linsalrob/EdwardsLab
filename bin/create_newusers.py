...
if __name__ == "__main__":
    ...
    parser.add_argument('-h', '--home', help="home location. Don't add leading or trailing path. Default = home", default='/home/')
    ...
    with open(args.users, 'w') as users, open(args.accounts, 'w') as accounts:
        for i in range(1, args.number):
            ...
            print(f"{args.base}{i:0>4}:{pwd}:::Rob Added User:/{args.home}/{args.base}{i:0>4}:/bin/bash", file=users)
