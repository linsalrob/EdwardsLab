...
def plotcoverage(x, y, plotax, ymax, xtitle, ytitle):
    """
    ...
    plotax.plot(x, y, color='blue', marker='None', linestyle='-')


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="")
    parser.add_argument('-b', help='bam file', default='/home/redwards/Desktop/GlobalCrassphage/gretel_reruns/SRR203317/SRR203317.bam')
    ...
    for i, primer in enumerate(['PrimerA', 'PrimerB', 'PrimerC']):
        ...
        plotcoverage(x, y, ax, ymax, "Coverage of {}".format(primer), "Average Read Depth")

    fig.set_facecolor('white')

    plt.tight_layout()
    plt.show()
    fig.savefig('/home/redwards/Desktop/GlobalCrassphage/gretel_reruns/SRR203317/SRR203317.png')